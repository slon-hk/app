...
var Rectangle = function (props) {
    ...
    var rectangleProps = __assign({}, transformLayoutStyleProperties_1.transformLayoutStyleProperties(style), transformGeometryStyleProperties_1.transformGeometryStyleProperties('fills', style, imageHash), transformBorderProperties_1.transformBorderStyleProperties(style), transformBlendProperties_1.transformBlendProperties(style), props, { style: style });
    ...
    return React.createElement("rectangle", __assign({}, rectangleProps, yogaProps, { innerRef: nodeRef }));
};
