...
var Vector = function (props) {
    ...
    var vectorProps = __assign({}, transformLayoutStyleProperties_1.transformLayoutStyleProperties(style), transformBlendProperties_1.transformBlendProperties(style), transformGeometryStyleProperties_1.transformGeometryStyleProperties('fills', style, imageHash), props, { style: style });
    ...
    return React.createElement("vector", __assign({}, vectorProps, yogaProps, { innerRef: nodeRef }));
};
