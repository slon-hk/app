...
var Ellipse = function (props) {
    ...
    var ellipseProps = __assign({}, transformLayoutStyleProperties_1.transformLayoutStyleProperties(style), transformBlendProperties_1.transformBlendProperties(style), transformGeometryStyleProperties_1.transformGeometryStyleProperties('fills', style, imageHash), props, { style: style });
    ...
    return React.createElement("ellipse", __assign({}, ellipseProps, yogaChildProps, { innerRef: nodeRef }));
};
