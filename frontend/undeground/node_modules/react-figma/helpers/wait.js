...
function actWait(amount) {
    if (amount === void 0) { amount = 0; }
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, react_test_renderer_1.act(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, wait(amount)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
